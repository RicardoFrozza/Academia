...
public class Professor extends JFrame {
	...
	public Professor() {
		...
		jtfSobrenhome = new JPanel();
		jtfSobrenhome.setBackground(Color.BLACK);
		jtfSobrenhome.setBorder(new EmptyBorder(5, 5, 5, 5));
		setContentPane(jtfSobrenhome);
		jtfSobrenhome.setLayout(null);
